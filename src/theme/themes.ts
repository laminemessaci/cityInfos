...
const common = {
  fade: (opacity: number) => `rgba(0,0,0,${opacity})`,
  fadeOut: (opacity: number) => `rgba(255,255,255,${opacity})`,
};

export const coffeeTheme: ITheme = {
  theme: SupportedTheme.COFFEE,
  fonts: {
